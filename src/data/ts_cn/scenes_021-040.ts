...
export const scenes_021_040: SceneData = {
  '21': {
    ...
    options: [
      {text: '和梅多聊聊天', goto: '31'},
      {text: '到外面转转，确认自己的方位', goto: '75'},
      {text: '提前上床早睡觉', goto: '63'},
    ],
  },
  '22': {
    id: '22',
    ...
    options: [
      {text: '稍作准备出村去', goto: '28'},
      {text: '转而造访村会堂', goto: '11'},
    ],
  },
  '23': {
    id: '23',
  ...
  '26': {
    ...
    entryEffects: [{type: EffectType.SET_FLAG, flagName: 'PENALTY_DICE_TODAY'}],
    options: [{text: '继续', goto: '64'}],
  },
  '27': {
    id: '27',
    story:
  ...
  '28': {
    ...
    checkOption: {
      ...
      success: {goto: '35', text: '进行「博物学」检定（成功）'},
      failure: {goto: '41', text: '进行「博物学」检定（失败）'},
    },
  },
  '29': {
    id: '29',
    ...
    options: [
      {text: '放弃这条路', goto: '120'},
      {
        ...
        condition: {
          ...
          characteristicKey: CheckObjectKey.DEX,
          comparisonCharacteristicKey: CheckObjectKey.SIZ,
          comparisonOperator: 'gt',
        },
      },
      {
        text: '前进（如果体型 >= 敏捷，进行敏捷检定）',
        goto: '???', // This should be handled by a checkOption like structure
        condition: {
          type: ConditionType.CHARACTERISTIC_COMPARE,
          characteristicKey: CheckObjectKey.SIZ,
          comparisonCharacteristicKey: CheckObjectKey.DEX,
          comparisonOperator: 'gte',
        },
        check: {
          // This check is part of the option, not a top-level checkOption
          object: 'characteristic',
          subObject: CheckObjectKey.DEX,
          difficulty: CheckDifficulty.NORMAL,
        },
        successGoto: '42', // Custom property for success
        failureGoto: '36', // Custom property for failure
      },
    ],
  },
  '30': {
  ...
  '31': {
    ...
    checkOption: {
      ...
      success: {goto: '39', text: '进行「魅惑」检定（成功）'},
      failure: {goto: '51', text: '进行「魅惑」检定（失败）'},
    },
  },
  '32': {
    id: '32',
  ...
  '34': {
    ...
    checkOption: {
      ...
      success: {goto: '46', text: '进行「骑术」检定（成功）'},
      failure: {goto: '25', text: '进行「骑术」检定（失败）'},
    },
  },
  '35': {
    id: '35',
    ...
    entryEffects: [
      {
        type: EffectType.MARK_SKILL_SUCCESS,
        skillKey: CheckObjectKey.NATURAL_WORLD,
      },
    ],
    options: [{text: '继续', goto: '54'}],
  },
  '36': {
    id: '36',
    story:
      '泥土随着你的踩踏下陷，断崖的边缘崩落了。你开始下坠，感觉自己的脏腑都在倾斜。\n进行一次「攀爬」检定。如果你成功了，前往48。如果你失败了，前往55。',
    checkOption: {
      check: {
        object: 'skill',
      ...
      success: {goto: '48', text: '进行「攀爬」检定（成功）'},
      failure: {goto: '55', text: '进行「攀爬」检定（失败）'},
    },
  },
  '37': {
    id: '37',
  ...
  '39': {
    ...
    entryEffects: [
      {type: EffectType.MARK_SKILL_SUCCESS, skillKey: CheckObjectKey.CHARM},
    ],
  ...
  '40': {
    ...
    options: [
      {
        text: '尝试奇怪的咒语',
        goto: '???' /* TODO: Link to spell casting scene, needs condition: HAS_SPELL_XYZ */,
        condition: {
          type: ConditionType.FLAG_SET,
          flagName: 'LEARNED_STRANGE_CHANT',
        },
      },
      {text: '不尝试咒语/未学过咒语', goto: '65'},
    ],
  },
}
