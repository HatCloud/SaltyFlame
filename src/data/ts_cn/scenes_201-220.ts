...
export const scenes_201_220: SceneData = {
    ...
    entryEffects: [
      {
        ...
        skillKey: CheckObjectKey.FIGHTING_BRAWL, // Corrected from FIGHT_BRAWL
      },
    ],
    options: [
      // Option for First Aid if injured
      {text: '（如果受伤）尝试「急救」检定', goto: 'S201_AID_CHECK'}, // Helper scene for check
      {text: '（如果未受伤或不急救）继续', goto: '79'},
    ],
  },
  S201_AID_CHECK: {
    // Helper scene for First Aid after bear fight
    id: 'S201_AID_CHECK',
    story: '你检查自己的伤势并尝试急救...',
    checkOption: {
      check: {
    ...
    entryEffects: [
      {
        ...
        flagName: 'LEARNED_SPELL_COMMAND_FIRE_FROM_SKY',
      },
    ],
    options: [{text: '继续', goto: '207'}],
  },
  '203': {
    id: '203',
    story:
      '有什么东西砸中了你的太阳穴，打得你晕头转向。你听到阿博加斯特的呼喊，看到刀刃的寒光：一刀、两刀、三刀，刀锋染上了殷红的鲜血。又有什么东西击中了你，在你倒下的时候，火焰从地上燃起，将夜空照得通亮。火光照出了三个黑影......\n（你）受到1D6点伤害。',
    entryEffects: [{type: EffectType.CHANGE_HP, value: '-1D6'}],
    options: [{text: '继续', goto: '45'}],
  },
  '204': {
    id: '204',
    story:
  ...
  '205': {
    ...
    options: [{text: '继续', goto: '27'}],
  },
  '206': {
    id: '206',
    story:
      '他那肿胀的嘴唇向上歪了一点点。“哎呀？你从哪儿听说这里的？”\n你含糊其辞地向他描述了报纸上的一篇报道。\n“我不读报这么长时间，报纸真的变了.”\n他的语调里带着些你不喜欢的东西。',
    options: [{text: '继续', goto: '221'}],
  },
  '207': {
    id: '207',
    story:
    ...
    checkOption: {
      ...
      success: {text: '进行“敏捷”检定（成功）', goto: '213'},
      failure: {text: '进行“敏捷”检定（失败）', goto: '190'},
    },
  },
  '208': {
    id: '208',
    ...
    checkOption: {
      ...
      success: {text: '进行「攀爬」检定（成功）', goto: '228'},
      failure: {text: '进行「攀爬」检定（失败，若96+则为大失败）', goto: '222'}, // PDF: 96 or higher is fumble to 222. Normal fail also to 222.
    },
  },
  '209': {
    id: '209',
    ...
    entryEffects: [{type: EffectType.CHANGE_SANITY, value: '-1D3'}], // TODO: Check for SAN zero in reducer
    options: [
      {text: '号令群星返回原位', goto: '255'},
      {text: '号令群星放你解脱', goto: '243'},
      {text: '号令群星烧尽村民', goto: '231'},
    ],
  },
  '210': {
    id: '210',
  ...
  '211': {
    ...
    entryEffects: [
      {type: EffectType.MARK_SKILL_SUCCESS, skillKey: CheckObjectKey.STEALTH},
    ],
    options: [{text: '继续', goto: '223'}],
  },
  '212': {
    id: '212',
    story:
  ...
  '219': {
    ...
    options: [
      {text: '尝试撬开挂锁', goto: '225'},
      {text: '暴力闯入这间上锁的工坊', goto: '232'},
      {text: '移动到其他地方', goto: '120'},
    ],
  },
  '220': {
    id: '220',
