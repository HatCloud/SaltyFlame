...
export const scenes_181_200: SceneData = {
  ...
  '184': {
    ...
    entryEffects: [
      {type: EffectType.ADD_ITEM, itemName: '阿撒托斯及其他_from_184'},
    ], // Differentiate from 159 if needed
  ...
  '188': {
    ...
    checkOption: {
      ...
      success: {text: '进行「闪避」检定（成功）', goto: '195'},
      failure: {text: '进行「闪避」检定（失败）', goto: '203'},
    },
  },
  '189': {
    id: '189',
    ...
    checkOption: {
      ...
      success: {text: '进行“幸运”检定（成功）', goto: '204'},
      failure: {text: '进行“幸运”检定（失败）', goto: '196'},
    },
  },
  '190': {
    id: '190',
  ...
  '194': {
    ...
    options: [
      {text: '寻找梅·莱德贝特的房子', goto: '267'},
      {text: '问西拉斯他在哪里过夜', goto: '251'},
      {text: '向西拉斯怀疑这次故障', goto: '257'},
    ],
  },
  '195': {
    id: '195',
    ...
    checkOption: {
      ...
      success: {text: '进行“理智”检定（成功）', goto: '210'},
      failure: {text: '进行“理智”检定（失败）', goto: '217'},
    },
  },
  '196': {
    id: '196',
    ...
    entryEffects: [
      {
        ...
        flagName: 'LEARNED_SPELL_SUMMON_FIRE_FROM_SKY',
      },
  ...
  '199': {
    ...
    options: [
      {text: '坚称自己是来参加节日的', goto: '206'},
      {text: '承认西拉斯把自己撂到这里了', goto: '214'},
    ],
  },
  '200': {
    id: '200',
