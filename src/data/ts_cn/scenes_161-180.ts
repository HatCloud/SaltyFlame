...
export const scenes_161_180: SceneData = {
  ...
  '165': {
    ...
    checkOption: {
      ...
      success: {text: '进行「图书馆使用」检定（成功）', goto: '177'},
      failure: {text: '进行「图书馆使用」检定（失败）', goto: '184'}, // PDF also mentions re-roll option
    },
    // TODO: Handle re-roll logic for failed Library Use check (if player chooses to) leading to 190 on second fail.
  },
  '166': {
    id: '166',
    story:
    ...
    options: [
      {
        ...
        condition: {
          ...
          flagName: 'LAST_NIGHT_SKILL_CHECK_SUCCESS_AND_INVESTIGATE',
        },
      }, // Placeholder flag
      {text: '（否则）', goto: '192'},
    ],
  ...
  '167': {
    ...
    options: [
      {text: '（假设受到重伤）', goto: '179'},
      {text: '（假设未受重伤）', goto: '186'},
    ],
  },
  '168': {
    id: '168',
  ...
  '169': {
    ...
    options: [
      {text: '学习奇怪的咒语', goto: '175'},
      {text: '已经受够阿博加斯特了', goto: '182'},
    ],
  },
  '170': {
    id: '170',
  ...
  '171': {
      ...
      success: {
        ...
        effects: [
          {type: EffectType.CHANGE_SANITY, value: '-1'},
          {
            ...
            flagName: 'FLAG_INCREASE_CTHULHU_MYTHOS_4',
          }, // Reducer handles skill increase
        ],
      },
      failure: {
        text: '理智检定失败',
    ...
    // options: [{text: '游戏结束', goto: 'END'}], // Options are handled by checkOption now
  },
  '172': {
    id: '172',
    story:
      '你逐渐靠近那个男人。他回头怒视着你。“你这混账，”他啐道，放慢了脚步。“你能离开我吗？”\n你向他保证自己对他没有恶意。\n他说：“我们不能在这里说话。跟我来.”',
    options: [{text: '继续', goto: '142'}],
  },
  '173': {
    id: '173',
    story:
    ...
    options: [
      {text: '（战斗后，假设失败并受重伤）', goto: '193'},
      {text: '（战斗后，假设三轮后未倒下）', goto: '201'},
    ],
  },
  '174': {
    id: '174',
    ...
    entryEffects: [
      {
        type: EffectType.MARK_SKILL_SUCCESS,
        skillKey: CheckObjectKey.DRIVE_AUTO,
      },
    ],
    options: [{text: '继续', goto: '194'}],
  },
  '175': {
    ...
    // Player learns a spell/secret.
    entryEffects: [
      {type: EffectType.SET_FLAG, flagName: 'LEARNED_ABOGASTR_CHANT'},
    ],
    options: [{text: '继续', goto: '188'}],
  },
  '176': {
    id: '176',
    story:
    ...
    checkOption: {
      ...
      success: {text: '进行困难“力量”检定（成功）', goto: '189'},
      failure: {text: '进行困难“力量”检定（失败）', goto: '183'},
    },
  },
  '177': {
    id: '177',
    ...
    entryEffects: [
      {
        type: EffectType.MARK_SKILL_SUCCESS,
        skillKey: CheckObjectKey.LIBRARY_USE,
      },
    ],
    options: [
      {text: '记住“召唤天之火”', goto: '197'},
      {text: '记住“号令天之火”', goto: '202'},
      {text: '把书放回去然后离开', goto: '120'},
    ],
  },
  '178': {
    id: '178',
    ...
    checkOption: {
      ...
      success: {text: '进行「侦查」检定（成功）', goto: '112'},
      failure: {text: '进行「侦查」检定（失败）', goto: '192'},
    },
  },
  '179': {
    id: '179',
    ...
    checkOption: {
      ...
      success: {text: '进行“体质”检定（成功）', goto: '186'},
      failure: {text: '进行“体质”检定（失败）', goto: '193'},
    },
  },
  '180': {
    id: '180',
    ...
    options: [
      {text: '到外面眺望星空', goto: '131'},
      {text: '试着和露丝说说话', goto: '138'},
