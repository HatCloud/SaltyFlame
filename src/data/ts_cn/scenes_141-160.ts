...
export const scenes_141_160: SceneData = {
  '141': {
    ...
    checkOption: {
      check: {
        ...
        subObject: CheckObjectKey.POW,
        difficulty: CheckDifficulty.NORMAL,
      },
      success: {text: '理智检定成功', goto: '63'},
      failure: {
        text: '理智检定失败',
        goto: 'S141_SAN_LOSS_THEN_63',
        effects: [{type: EffectType.CHANGE_SANITY, value: '-1D2'}],
      },
    },
  },
  S141_SAN_LOSS_THEN_63: {
    id: 'S141_SAN_LOSS_THEN_63',
    story: '你感到一阵不安，但还是努力让自己镇定下来。',
    options: [{text: '继续', goto: '63'}],
  },
  '142': {
    id: '142',
    story:
  ...
  '143': {
    ...
    entryEffects: [
      {type: EffectType.SET_FLAG, flagName: 'FLAG_INCREASE_NATURAL_WORLD_2'}, // Reducer handles this
    ],
    options: [{text: '继续', goto: '79'}],
  },
  '144': {
    id: '144',
    story:
    ...
    options: [
      {text: '尝试「汽车驾驶」检定', goto: 'S144_AUTODRIVE_CHECK'},
      {text: '尝试「心理学」（困难）检定', goto: 'S144_PSYCH_CHECK'},
    ],
  },
  S144_AUTODRIVE_CHECK: {
    id: 'S144_AUTODRIVE_CHECK',
    story: '你尝试分析车辆的状况...',
    checkOption: {
      check: {
        object: 'skill',
      ...
      success: {text: '汽车驾驶检定成功', goto: '174'},
      failure: {text: '汽车驾驶检定失败', goto: '194'},
    },
  },
  S144_PSYCH_CHECK: {
    id: 'S144_PSYCH_CHECK',
    ...
    checkOption: {
      ...
      success: {text: '心理学检定困难成功', goto: '162'},
      failure: {text: '心理学检定失败', goto: '194'},
    },
  },
  '145': {
    id: '145',
    ...
    // entryEffects: [{type: EffectType.MARK_SKILL_SUCCESS, skillKey: CheckObjectKey.CHARM_OR_PERSUADE_OR_FASTTALK}], // Placeholder, depends on path from S138
    options: [{text: '继续', goto: '157'}],
  },
  '146': {
    id: '146',
    story:
    ...
    entryEffects: [
      {type: EffectType.MARK_SKILL_SUCCESS, skillKey: CheckObjectKey.DISGUISE},
    ],
    options: [{text: '继续', goto: '152'}],
  },
  '147': {
    id: '147',
    story:
    ...
    options: [
      {text: '调查书架后面', goto: '153'},
      {text: '关上书架，趁着还早赶快逃离', goto: '120'},
    ],
  },
  '148': {
    id: '148',
  ...
  '150': {
    ...
    options: [
      {text: '进行对抗检定（假设你胜出）', goto: '172'},
      {text: '进行对抗检定（假设你落败）', goto: '87'},
    ],
  },
  '151': {
    id: '151',
  ...
  '152': {
    ...
    checkOption: {
      ...
      success: {text: '进行「潜行」检定（成功）', goto: '211'},
      failure: {text: '进行「潜行」检定（失败）', goto: '216'},
    },
  },
  '153': {
    id: '153',
    ...
    options: [
      {text: '冒险把悬崖边的窗户打开一点点', goto: '165'},
      {text: '抓上几本书就离开', goto: '159'},
    ],
  },
  '154': {
    id: '154',
    ...
    entryEffects: [{type: EffectType.CHANGE_HP, value: '+1'}], // Conditional logic (IF_INJURED) to be handled by reducer
    options: [{text: '继续', goto: '166'}],
  },
  '155': {
    id: '155',
    story:
    ...
    options: [
      {text: '进行对抗检定（假设你胜出）', goto: '161'},
      {text: '进行对抗检定（假设你落败）', goto: '167'},
    ],
  },
  '156': {
    id: '156',
    ...
    options: [
      {text: '等等看灯塔会发生什么', goto: '168'},
      {text: '立即骑车出村', goto: '185'},
    ],
  },
  '157': {
    id: '157',
        ...
        effects: [
          {
            ...
            skillKey: CheckObjectKey.STEALTH,
          },
        ],
      },
      failure: {text: '进行「潜行」检定（失败）', goto: '170'},
    },
  },
  '159': {
    id: '159',
    ...
    entryEffects: [{type: EffectType.ADD_ITEM, itemName: '阿撒托斯及其他'}],
    options: [{text: '继续', goto: '120'}],
  },
  '160': {
    id: '160',
    story:
    ...
    options: [{text: '继续', goto: '25'}],
  },
}

// Helper scenes for scene 138, if needed, or handle skill choice in reducer
// S138_CHARM_CHECK: { id: 'S138_CHARM_CHECK', checkOption: { check: { object: 'skill', subObject: CheckObjectKey.CHARM ... success: 145, failure: 151 }}}
// S138_PERSUADE_CHECK: { id: 'S138_PERSUADE_CHECK', checkOption: { check: { object: 'skill', subObject: CheckObjectKey.PERSUADE ... success: 145, failure: 151 }}}
// S138_FASTTALK_CHECK: { id: 'S138_FASTTALK_CHECK', checkOption: { check: { object: 'skill', subObject: CheckObjectKey.FAST_TALK ... success: 145, failure: 151 }}}
