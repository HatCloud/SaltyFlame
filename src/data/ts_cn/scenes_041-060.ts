...
export const scenes_041_060: SceneData = {
  ...
  '43': {
    ...
    options: [
      {text: '立即询问电报的事', goto: '56'},
      {text: '先和文特斯先生先聊聊', goto: '49'},
    ],
  },
  '44': {
    id: '44',
    ...
    checkOption: {
      ...
      success: {text: '进行困难“力量”检定（成功）', goto: '53'},
      failure: {text: '进行困难“力量”检定（失败）', goto: '40'},
    },
  },
  '45': {
    id: '45',
  ...
  '48': {
    ...
    entryEffects: [
      {type: EffectType.MARK_SKILL_SUCCESS, skillKey: CheckObjectKey.CLIMB},
    ],
    options: [{text: '继续', goto: '61'}],
  },
  '49': {
  ...
  '52': {
    ...
    checkOption: {
      ...
      success: {text: '体质检定成功', goto: '64'},
      failure: {
        text: '体质检定失败 (有惩罚骰)',
        goto: '64',
        effects: [{type: EffectType.SET_FLAG, flagName: 'PENALTY_DICE_TODAY'}], // Assuming PENALTY_DICE_TODAY is a valid flag
      },
    },
  },
  '53': {
    ...
    checkOption: {
      ...
      success: {text: '进行困难“闪避”检定（成功）', goto: '109'},
      failure: {text: '进行困难“闪避”检定（失败）', goto: '123'},
    },
  },
  '54': {
    id: '54',
    ...
    options: [
      {text: '上山辨认别的村庄', goto: '60'},
      {text: '尝试小径', goto: '85'},
      {text: '继续沿着道路走确保安全', goto: '103'},
    ],
  },
  '55': {
    id: '55',
    ...
    entryEffects: [{type: EffectType.CHANGE_HP, value: '-2D6'}], // Apply damage
    options: [
      // Player chooses based on the outcome described in the story
      {text: '（若伤害 >= 最大HP一半）继续', goto: '67'},
      {text: '（若伤害 < 最大HP一半）继续', goto: '73'},
    ],
  },
  '56': {
    id: '56',
    ...
    options: [
      {text: '谢过文特斯先生并离开', goto: '180'},
      {text: '询问他的藏书室', goto: '62'},
    ],
  },
  '57': {
    id: '57',
    ...
    checkOption: {
      ...
      success: {text: '进行「侦查」检定（成功）', goto: '69'},
      failure: {text: '进行「侦查」检定（失败）', goto: '25'},
    },
  },
  '58': {
    id: '58',
    ...
    entryEffects: [{type: EffectType.CHANGE_HP, value: '+1'}], // Conditional logic for "if injured" needs to be handled by the reducer
    options: [{text: '继续', goto: '64'}],
  },
  '59': {
    id: '59',
  ...
  '60': {
    ...
    checkOption: {
      ...
      success: {text: '进行「考古学」检定（成功）', goto: '66'},
      failure: {text: '进行「考古学」检定（失败）', goto: '72'},
    },
  },
}
