...
export const scenes_081_100: SceneData = {
  ...
  '83': {
    ...
    checkOption: {
      ...
      success: {text: '进行「侦查」检定（成功）', goto: '95'},
      failure: {text: '进行「侦查」检定（失败）', goto: '89'},
    },
  },
  '84': {
    id: '84',
  ...
  '85': {
    ...
    checkOption: {
      check: {
        object: 'characteristic', // PDF says "幸运"检定 which is a characteristic
        subObject: CheckObjectKey.LUCK, // Assuming LUCK is a key in CheckObjectKey for characteristics
        difficulty: CheckDifficulty.NORMAL,
      },
      success: {text: '进行“幸运”检定（成功）', goto: '91'},
      failure: {text: '进行“幸运”检定（失败）', goto: '97'},
    },
  },
  '86': {
    id: '86',
  ...
  '87': {
    ...
    checkOption: {
      ...
      success: {text: '进行困难「侦查」检定（成功）', goto: '181'},
      failure: {text: '放弃追逐', goto: '160'},
    },
  },
  '88': {
    id: '88',
    ...
    options: [
      {
        ...
        goto: 'S89_REROLL_CHECK', // New scene ID for the re-roll check
      },
      {text: '不想冒险继续', goto: '120'},
    ],
  },
  '90': {
    id: '90',
    ...
    options: [{text: '决定消耗的点数后继续', goto: '198'}], // Player needs to decide MP/HP to spend.
  },
  '91': {
    id: '91',
    story:
    ...
    entryEffects: [
      {
        ...
        value: '+1',
        // condition: 'HAD_LOST_SANITY', // Conditional logic to be handled by reducer
      },
    ],
    options: [{text: '继续', goto: '99'}],
  },
  ...
  '96': {
    ...
    checkOption: {
      ...
      success: {text: '进行「心理学」检定（成功）', goto: '106'},
      failure: {text: '进行「心理学」检定（失败）', goto: '25'},
    },
  },
  '97': {
    id: '97',
    ...
    entryEffects: [{type: EffectType.CHANGE_HP, value: '-1D3'}],
    // The first aid check is an option for the player, not an automatic checkOption
    options: [
      {
        text: '尝试「急救」检定',
        goto: 'S97_AID_CHECK', // New scene ID for the First Aid check
      },
      {text: '不尝试急救，继续', goto: '79'},
    ],
  },
  '98': {
    id: '98',
  ...
  '99': {
    ...
    checkOption: {
      ...
      success: {text: '进行「信用评级」检定（成功）', goto: '111'},
      failure: {text: '进行「信用评级」检定（失败）', goto: '105'},
    },
  },
  '100': {
    id: '100',
  ...
  // --- Helper scenes for checks from options ---
  S89_REROLL_CHECK: {
    id: 'S89_REROLL_CHECK',
    story: '你决定孤注一掷，再次仔细搜索房间...',
    checkOption: {
      check: {
        object: 'skill',
        subObject: CheckObjectKey.SPOT_HIDDEN,
      ...
      success: {text: '（重新侦查成功）', goto: '95'},
      failure: {text: '（重新侦查失败）', goto: '101'},
    },
  },
  S97_AID_CHECK: {
    id: 'S97_AID_CHECK',
      ...
      success: {
        ...
        effects: [
          {type: EffectType.CHANGE_HP, value: '+1'},
          {
            ...
            skillKey: CheckObjectKey.FIRST_AID,
          },
        ],
      },
      failure: {text: '（急救失败）', goto: '79'},
    },
  },
}
