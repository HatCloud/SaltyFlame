...
export const scenes_101_120: SceneData = {
  ...
  '103': {
    ...
    options: [
      {text: '进一步观察熊', goto: '110'},
      {text: '无动于衷', goto: '116'},
      {text: '慎重行事，慢慢退却', goto: '122'},
    ],
  },
  '104': {
    id: '104',
    ...
    entryEffects: [
      {
        ...
        skillKey: CheckObjectKey.PSYCHOLOGY,
      },
    ],
  ...
  '109': {
    ...
    entryEffects: [{type: EffectType.CHANGE_HP, value: '-1D6'}], // TODO: Add HP check for death
    options: [{text: '（若未死）继续', goto: '137'}], // Conditional on not dying
  },
  '110': {
    id: '110',
    ...
    checkOption: {
      check: {
        object: 'skill',
        subObject: CheckObjectKey.STEALTH, // Assuming STEALTH is the key for 潜行
        difficulty: CheckDifficulty.EXTREME, // 极难
      },
      success: {text: '进行极难「潜行」检定（成功）', goto: '143'},
      failure: {text: '进行极难「潜行」检定（失败）', goto: '129'}, // PDF also mentions "大失败" (fumble) for 96+ -> 149
    },
    // TODO: Handle fumble (96+) for STEALTH check leading to 149.
    // This might require a more complex check result structure or reducer logic.
  },
  '111': {
    id: '111',
    story:
    ...
    checkOption: {
      ...
      success: {text: '进行「侦查」检定（成功）', goto: '118'},
      failure: {text: '进行「侦查」检定（失败）', goto: '124'},
    },
  },
  '112': {
    id: '112',
    ...
    entryEffects: [
      ...
      {
        type: EffectType.MARK_SKILL_SUCCESS,
        skillKey: CheckObjectKey.SPOT_HIDDEN,
      },
      // The "secret" part is informational for the player, not a direct game state change here.
    ],
    options: [{text: '继续', goto: '192'}],
  },
  '113': {
    id: '113',
    story:
  ...
  '115': {
    ...
    checkOption: {
      ...
      success: {text: '进行“幸运”检定（成功）', goto: '127'},
      failure: {text: '进行“幸运”检定（失败）', goto: '135'},
    },
  },
  '116': {
    id: '116',
    ...
    checkOption: {
      ...
      success: {text: '进行“幸运”检定（成功）', goto: '136'},
      failure: {text: '进行“幸运”检定（失败）', goto: '129'},
    },
  },
  '117': {
    id: '117',
    ...
    checkOption: {
      check: {
        object: 'characteristic',
        subObject: CheckObjectKey.APP, // 外貌检定
        difficulty: CheckDifficulty.NORMAL,
      },
      success: {text: '进行“外貌”检定（成功）', goto: '10'},
      failure: {text: '进行“外貌”检定（失败）', goto: '148'},
    },
  },
  '118': {
    id: '118',
  ...
  '119': {
    ...
    checkOption: {
      check: {
        object: 'skill',
        subObject: CheckObjectKey.FAST_TALK, // 话术
        difficulty: CheckDifficulty.EXTREME, // 极难
      },
      success: {text: '进行极难「话术」检定（成功）', goto: '132'},
      failure: {text: '进行极难「话术」检定（失败）', goto: '139'},
    },
  },
  '120': {
    id: '120',
    ...
    options: [
      {text: '搜索梅·莱德贝特的卧室', goto: '83'},
      {text: '独自前往村会堂', goto: '126'},
      {text: '仔细勘查工匠的工坊', goto: '219'},
      {text: '窥探灯塔前的活动', goto: '29'},
      {text: '沿东盘山路下山，溜之大吉', goto: '7'},
