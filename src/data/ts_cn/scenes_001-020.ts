...
export const scenes_001_020: SceneData = {
  ...
  '3': {
    ...
    options: [
      {text: '问露丝她说的是什么意思', goto: '9'},
      {text: '问梅露丝说的是什么意思', goto: '15'},
      {text: '一言不发', goto: '22'},
    ],
  },
  '4': {
    ...
    options: [
      {text: '解释西拉斯和他的长途车的事', goto: '14'},
      {text: '询问有关节日的事', goto: '21'},
    ],
  },
  '5': {
    id: '5',
    ...
    entryEffects: [{type: EffectType.CHANGE_SANITY, value: '-1D3'}],
  ...
  '6': {
    ...
    options: [
      {text: '去本地杂货店询问交通方式', goto: '16'},
      {text: '找到村会堂', goto: '84'},
      {text: '沿着道路下坡，查看东盘山路', goto: '115'},
      {text: '调查巨大的金属建筑物', goto: '57'},
      {text: '探索教堂', goto: '34'},
      {text: '寻找拥有交通工具的当地居民', goto: '96'},
    ],
  },
  '7': {
    id: '7',
    ...
    options: [
      {text: '尝试靠口才通过把守村口的人群', goto: '119'},
      {text: '尝试化装通过', goto: '125'},
      {text: '难道......你还知道其他出村的办法吗？', goto: '???'},
    ],
  },
  '8': {
    id: '8',
  ...
  '12': {
    ...
    entryEffects: [
      {type: EffectType.MARK_SKILL_SUCCESS, skillKey: CheckObjectKey.DODGE},
    ],
  ...
  '17': {
    ...
    checkOption: {
      ...
      success: {goto: '30', text: '侦查布告板（成功）'},
      failure: {goto: '37', text: '侦查布告板（失败）'},
    },
  },
  '18': {
    id: '18',
    ...
    entryEffects: [
      {
        ...
        skillKey: CheckObjectKey.INTIMIDATE,
      },
    ],
    options: [
