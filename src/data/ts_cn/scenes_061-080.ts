...
export const scenes_061_080: SceneData = {
  ...
  '62': {
    ...
    options: [
      {text: '花点时间在图书馆里研究研究', goto: '68'},
      {text: '趁天色还早时离开', goto: '180'},
    ],
  },
  '63': {
    id: '63',
    ...
    options: [
      {
        ...
        condition: {
          ...
          flagName: 'FOUGHT_LAST_NIGHT',
        }, // Assuming this flag will be set
      },
      {text: '否则', goto: '78'},
    ],
  },
  '65': {
    ...
    entryEffects: [{type: EffectType.CHANGE_HP, value: '-1D6'}], // TODO: Add HP check for death in reducer
    checkOption: {
      check: {
      ...
      success: {text: '进行“力量”检定（成功）', goto: '93'},
      failure: {text: '进行“力量”检定（失败）', goto: '77'},
    },
  },
  '66': {
    id: '66',
    ...
    entryEffects: [
      {
        ...
        skillKey: CheckObjectKey.ARCHAEOLOGY,
      },
    ],
  ...
  '67': {
    ...
    checkOption: {
      ...
      success: {text: '进行“体质”检定（成功）', goto: '82'},
      failure: {text: '进行“体质”检定（失败或HP为0）', goto: '92'},
    },
  },
  '68': {
    id: '68',
    ...
    options: [
      {text: '研读本地历史相关的内容', goto: '74'},
      {text: '研读节日相关的内容', goto: '81'},
      {text: '研读科学书籍', goto: '88'},
      {text: '研读怪诞小说', goto: '94'},
    ],
  },
  ...
  '73': {
    ...
    // This is a conditional goto based on HP.
    // For now, I'll represent this with two options, assuming player/reducer handles the HP check.
    options: [
      {text: '（若HP > 0）继续', goto: '82'},
      {text: '（若HP <= 0）前往结局', goto: '92'},
    ],
  },
  '74': {
    id: '74',
  ...
  '76': {
    ...
    entryEffects: [
      {
        type: EffectType.MARK_SKILL_SUCCESS,
        skillKey: CheckObjectKey.SCIENCE_BOTANY,
      },
    ], // Assuming SCIENCE_BOTANY is a key in CheckObjectKey
    options: [
      {text: '小睡一会', goto: '58'},
      {text: '彻夜不眠', goto: '52'},
    ],
  ...
  '77': {
    ...
    options: [{text: '游戏结束', goto: 'END'}], // END signifies an ending
  },
  '78': {
    id: '78',
    story:
  ...
  '79': {
    ...
    checkOption: {
      ...
      success: {text: '进行困难难度的「聆听」检定（成功）', goto: '240'},
      failure: {text: '进行困难难度的「聆听」检定（失败）', goto: '234'},
    },
  },
  '80': {
    id: '80',
