...
export const professorTemplate: OccupationTemplate = {
  ...
  background_cn: {
    ...
    significantPeople:
      '一位曾经的学生，现在在某个意想不到的领域取得了成就，并带来了麻烦的委托。',
    meaningfulLocations:
      '自己那间堆满了书籍和研究资料的办公室，窗外是宁静的校园。',
    treasuredPossessions: '一本罕见的学术专著，扉页有作者的亲笔签名。',
    traits:
  ...
  background_en: {
    ...
    significantPeople:
      'A former student who has achieved success in an unexpected field and brought a troublesome commission.',
    meaningfulLocations:
      'My own office, piled high with books and research materials, overlooking the tranquil campus.',
    treasuredPossessions:
      "A rare academic monograph with the author's autograph on the flyleaf.",
    traits:
